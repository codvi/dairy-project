...
const { createHealthRecord, getHealthRecords, getHealthRecordById, updateHealthRecord, deleteHealthRecord } = require('../middleware/healthRecordMiddleware');
...
healthRecordrouter.get('/getHealthRecords/:livestockId', auth, getHealthRecords);
